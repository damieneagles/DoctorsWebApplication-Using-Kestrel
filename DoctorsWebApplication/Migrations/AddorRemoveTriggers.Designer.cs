...
namespace DoctorsWebApplication.Migrations
{
    ...
    [Migration("AddorRemoveTriggers")]
    partial class AddorRemoveTriggers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorsWebApplication.Models.DoctorFeesExtended", b =>
                {
                    b.Property<int>("DoctorFeesExtendedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DoctorFeesExtendedId"));

                    b.Property<double>("AppointmentDurationInMinutes")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DoctorsWebApplication.Models.DoctorFeesExtended", b =>
                {
                    ...
                    b.HasOne("DoctorsWebApplication.Models.AppointmentPayment", "AppointmentPayment")
                        .WithMany()
